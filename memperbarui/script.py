...
figlet JUNTRI V3 | lolcat

echo -e  "________________________________________________"
echo -e  "Tools    : JUNTRI PJR $white         " |lolcat
echo -e  "Facebook  : juntriptra $white   " |lolcat
echo -e  "WA  : 082159274814 $white " |lolcat
echo -e  "Youtube:  JUNTRI HACKER  $white " |lolcat
echo -e  "________________________________________________"
...
8) git clone https://github.com/sanjayaajo/hackfb_terbaru.V3.git
cd hackfb_terbaru
...
0) echo "created by : juntri pjr Termux Thanks Sudah Pakai"
exit
;;
